 ...
 * nothing to act on — and asking puts a blocking modal over the dashboard the
 * moment they sign in. Brand accounts are excluded because a brand signs up to
 * sell, and being asked how to size ITS clothes on the way in misreads what
 * the account is for.
 *
 ...
 *
 * Deliberate twin of the file in the sibling repo — separate repos, so change
 * both or web and native start asking different people.
 */
