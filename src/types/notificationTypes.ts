...
export const NotificationTypes = {
  ...
  BAG_ITEM_ADDED: 'BAG_ITEM_ADDED',
  BAG_CHECKOUT_REMINDER: 'BAG_CHECKOUT_REMINDER',
...
> = {
  ...
  [NotificationTypes.BAG_ITEM_ADDED]: {
    actionText: 'added to your bag',
    actionKey: 'notification.action.bag_item_added',
    iconKey: 'order',
    routePattern: () => '/bag',
    defaultAriaAction: 'Open bag',
    trackingCategory: 'order',
  },
  [NotificationTypes.BAG_CHECKOUT_REMINDER]: {
    actionText: 'reminded you to check out',
    actionKey: 'notification.action.bag_checkout_reminder',
    iconKey: 'order_status',
    routePattern: () => '/bag',
    defaultAriaAction: 'Open bag',
    trackingCategory: 'order',
