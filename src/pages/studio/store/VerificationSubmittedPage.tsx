  ...
  return (
    <div className="space-y-6">
      ...
      <VerificationHero
        ...
        description="Your current evidence set is locked for reviewer handling. Track the queue state from the workspace and only re-enter the wizard when Threadly asks for updates."
      ...
      <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[1.75rem] border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 space-y-4 text-sm leading-7 text-gray-600">
            <p>Threadly reviewers pick up submissions from the queue in order.</p>
            <p>
