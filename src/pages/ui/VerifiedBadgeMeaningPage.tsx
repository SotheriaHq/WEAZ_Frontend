  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <nav className="mb-4 flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">
        ...
        <span>/</span>
        <span className="text-slate-800 dark:text-slate-100">Verified badge meaning</span>
      </nav>
      ...
      <section className="overflow-hidden rounded-[2rem] border border-white/70 bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.14),_transparent_30%),linear-gradient(135deg,_#f8fcff,_#ffffff_48%,_#eef8ff)] dark:bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.14),_transparent_30%),linear-gradient(135deg,_#101418,_#0a0a0a_48%,_#0d1116)] p-8 shadow-[0_30px_80px_-40px_rgba(14,165,233,0.45)]">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            to={returnTo}
            className="inline-flex items-center rounded-full border border-indigo-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-indigo-700 shadow-sm transition hover:border-indigo-300 hover:bg-indigo-50 dark:border-indigo-500/30 dark:text-indigo-300 dark:bg-white/5"
          >
            Return to previous page
          </Link>
          <Link
            to="/studio/store"
            className="inline-flex items-center rounded-full border border-gray-300 bg-theme px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-gray-700 shadow-sm transition hover:border-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 dark:text-gray-300"
          >
            Back to studio store
          </Link>
          <Link
            to="/studio/verification"
            className="inline-flex items-center rounded-full border border-emerald-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-emerald-700 shadow-sm transition hover:border-emerald-300 hover:bg-emerald-50 dark:border-emerald-500/30 dark:text-emerald-300 dark:bg-white/5"
          >
