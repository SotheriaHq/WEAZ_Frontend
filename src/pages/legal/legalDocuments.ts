import type { LegalDocumentKey } from '@/api/LegalApi';
...
export const LEGAL_PAGE_VERSION = '2026.06.08-weaz-draft.1';
export const LEGAL_PAGE_EFFECTIVE_DATE =
...
export const LEGAL_PAGES: LegalPageDefinition[] = [
  {
    ...
    effectiveDate: LEGAL_PAGE_EFFECTIVE_DATE,
    version: LEGAL_PAGE_VERSION,
