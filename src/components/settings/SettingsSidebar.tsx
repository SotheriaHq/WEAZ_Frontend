...
export const SettingsSidebar: React.FC<SettingsSidebarProps> = ({ active, onSelect }) => {
  ...
  return (
    <aside className="hidden md:block fixed left-0 top-16 h-[calc(100vh-64px)] w-[240px] bg-gray-50 dark:bg-[#0f0f0f] z-20 overflow-y-auto scrollbar-hide border-r border-gray-200 dark:border-white/5">
      <div className="py-4">
        ...
        <nav className="space-y-1">
          ...
          {/* Studio Section (Collapsible) - Direct dropdown, no nested icon */}
          <button
