                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="group/input relative">
                                ...
                                <div className="flex items-center px-4 py-3 bg-gray-100/50 dark:bg-black/20 border border-gray-200 dark:border-white/5 rounded-xl text-gray-500 dark:text-white/60 cursor-not-allowed backdrop-blur-sm">
                                    <span className="font-medium text-gray-700 dark:text-gray-300">{initialValues.brandFullName}</span>
                            ...
                            <div className="group/input relative">
                                ...
                                <div className="flex items-center px-4 py-3 bg-gray-100/50 dark:bg-black/20 border border-gray-200 dark:border-white/5 rounded-xl text-gray-500 dark:text-white/60 cursor-not-allowed backdrop-blur-sm">
                                    <span className="font-medium text-gray-700 dark:text-gray-300">@{initialValues.username}</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-gray-400 dark:text-white/10 ml-auto" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
                                        <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
                                    </svg>
                            ...
                            <div className="md:col-span-4">
                                ...
                                <div className="relative">
                                    <input 
                                        type="text"
                                        placeholder="Country"
                                        className="w-full bg-white/60 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-purple-500 focus:ring-0 transition-all duration-300 placeholder-gray-400"
                        ...
                        <div className="flex justify-between items-end">
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1 flex items-center gap-2">
                                    Brand Vibe
                                    <span className="text-xs font-normal text-gray-500 dark:text-white/40 bg-gray-100 dark:bg-white/5 px-2 py-0.5 rounded-full border border-gray-200 dark:border-white/5">Select up to 5</span>
                                </h3>
                                    ...
                                    <button
                                        ...
                                        className={`group relative px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 transform hover:-translate-y-0.5 ${
                                            isSelected 
                                                ...
                                                : 'bg-white/60 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-white/70 hover:bg-white dark:hover:bg-white/10 hover:border-gray-300 dark:hover:border-white/30'
                                        }`}
                                    >
