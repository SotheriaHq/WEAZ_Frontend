...
> = {
  design: {
    ...
    saveLabel: 'Clip design',
    unsaveLabel: 'Unclip design',
  ...
  product: {
    ...
    saveLabel: 'Clip product',
    unsaveLabel: 'Unclip product',
  ...
  collection: {
    ...
    saveLabel: 'Clip collection',
    unsaveLabel: 'Unclip collection',
