    ...
    <div className="fixed inset-0 z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div
          ...
          role="dialog"
          aria-modal="true"
          className="relative flex w-full max-h-[90vh] max-w-[640px] flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.06] shadow-2xl backdrop-blur-xl"
        >
          {/* Header (natural height; not fixed) */}
          <div className="shrink-0 border-b border-white/5 px-8 pb-6 pt-10 text-center">
            <div className="relative mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full border border-white/10 bg-white/[0.06] text-purple-400">
              <div
                className="absolute inset-0 rounded-full bg-purple-500/25 blur-xl"
                aria-hidden="true"
              />
              <Store className="relative h-8 w-8" />
              <div className="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full border-2 border-black/60 bg-amber-500">
          ...
          {/* Body (scrollable; owns scrolling) */}
          <div className="flex-1 overflow-y-auto overscroll-contain p-6 md:p-8">
            <div className="space-y-3">
              {REQUIRED_ORDER.map((item) => {
                ...
                const rowBase =
                  'group flex items-center justify-between rounded-xl border bg-white/[0.02] p-4 transition-colors';
          ...
          {/* Footer */}
          <div className="bg-black/20 p-8 pt-2">
            ...
            <div className="flex w-full flex-col-reverse gap-3 md:flex-row">
              <button
                ...
                ref={goBackButtonRef}
                className="flex-1 rounded-lg border border-white/10 px-6 py-3 font-medium text-white transition-colors hover:bg-white/5 active:scale-[0.98]"
              >
                Go Back
              </button>
              <button
                ...
                className="group flex-[2] rounded-lg bg-gradient-to-r from-purple-700 to-purple-600 px-6 py-3 font-bold text-white shadow-lg shadow-purple-900/30 transition-all hover:from-purple-600 hover:to-purple-500 active:scale-[0.98]"
              >
