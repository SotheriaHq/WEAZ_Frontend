...
export const StudioSidebar: React.FC<StudioSidebarProps> = ({ active, onSelect }) => {
  ...
  return (
    <>
      <aside className="hidden lg:block fixed left-0 top-16 h-[calc(100vh-64px)] w-[132px] z-20 overflow-y-auto scrollbar-hide border-r border-purple-200/20 dark:border-white/10 bg-transparent">
